...
export function SignupPage() {
  ...
  const onEmailRegister = async (e: FormEvent) => {
    e.preventDefault();
    setError(null);
    setLoading(true);
    try {
      const res = await postAuthJson("/api/v1/auth/register", {
      ...
      if (res.body.data.requiresEmailVerification) {
        navigate(
  ...
  return (
    <AuthShell
      ...
      subtitle="Email and password, or continue with Google or GitHub. OAuth accounts are verified automatically."
    >
